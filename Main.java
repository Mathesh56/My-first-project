...
public class Main {
    ...
    public Main() {
        ...
        users = new ArrayList<>();
        booksForSale.add(new Book("Book_1", "author_1", 200));
        booksForSale.add(new Book("Book_2", "author_2", 250));
        booksForSale.add(new Book("Book_3", "author_3", 150));

        users.add(new User("mathesh", "12345678"));
        users.add(new User("mathesh", "12345678"));
    }
